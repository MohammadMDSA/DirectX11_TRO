...
void Game::Render()
{
	...
	VertexPositionColor v1(Vector3(0.f, 0.5f, 0.5f), Colors::Green);
...
void Game::CreateDevice()
{
	...
	ThrowIfFailed(
		m_d3dDevice->CreateInputLayout(VertexPositionColor::InputElements, VertexPositionColor::InputElementCount, shaderByteCode, byteCodeLength, m_inputLayout.ReleaseAndGetAddressOf())
	);
