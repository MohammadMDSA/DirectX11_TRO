...
void Game::Render()
{
	...
	// Render anumated ship with scrolling background
	m_spriteBatch->Begin();
...
void Game::CreateDevice()
{
	...
	ThrowIfFailed(
		CreateWICTextureFromFile(m_d3dDevice.Get(), L"starfield.png", nullptr, m_backgroundTex.ReleaseAndGetAddressOf())
	);
